...
**Если система уже работает, шаг раздваивается.** «Какой системе быть» и «как в неё перейти» — разные решения с разными дисквалификаторами: [D-07 · Декомпозиция данных](decisions/D-07-data-decomposition.md) отвечает на первое, [D-08 · Миграция данных без остановки](decisions/D-08-data-migration.md) — на второе. Второе легко не заметить: оно выглядит исполнением первого, а по данным изменение системы ломает её чаще, чем её собственный код.
